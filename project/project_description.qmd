...
Each group will write a final report created in an `.Rmd` file. Ideally, the report will be submitted as a PDF (we will discuss how to do this as a class). **The code in your report should be as reproducible as possible** (e.g. not hard coding specific values, setting a [Presentation] when appropriate)**.**
...
Each group will present their work during the exam period. Presentation duration is a maximum of 3 minutes per group member (i.e. two-person groups have 6 minutes, three-person groups have 9 minutes, and four-person groups have 12 minutes). Your presentation will be followed by 1-2 minutes of questions from the audience.
...
-   You do not need to discuss all of your research questions if you don't want to! You are not expected to have finished all your analyses by the time you present, but you shouldhave *some* results (whether preliminary or finalized).
