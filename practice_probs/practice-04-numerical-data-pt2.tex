...
\item
  ...
  \def\labelenumii{\alph{enumii}.}
  \item
    Calculate the median number of healthy sunflowers in a grid cell for
    each of the sampling strategies. How do they compare to the sample
    means?
  \item
    Pick one of the sampling schemes. Draw out the boxplot for the data
    you obtained under that sampling scheme.
  \end{enumerate}
\end{enumerate}
