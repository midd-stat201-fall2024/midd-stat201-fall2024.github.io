...
We will use the `case_when()` function which generalizes `if_else()`. 
We use the following notation:  `<logical condition> ~ <value of variable>`. Different "ifs" are separated by commas, and the logical conditions are checked sequentially.
