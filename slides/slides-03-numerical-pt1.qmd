...
-   Variables can be broadly broken into two categories: numerical or categorical

-   **Numerical** variables take a wide range of numerical values, and it is sensible to add/subtract/do mathematical operations with those values

    -   Non-example: zip code

-   A numerical variable is **discrete** if it can only take on finitely many numerical values within a given interval

-   A numerical variable is **continuous** if it can take on any infinitely many values within a given interval
...
**Scatterplots** are *bivariate* (two-variable) visualizations that prove a case-by-case view of the data for two numerical variables
