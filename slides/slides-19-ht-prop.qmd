...
-   Calculate a **test statistic**: a quantity that assesses how consistent your sample data are with $H_{0}$
    ...
    ::: fragment
    $$z =\frac{\hat{p}_{\text{obs}} - p_{0}}{\text{SE}_{0}} =\frac{\hat{p}_{\text{obs}} - p_{0}}{\sqrt{\frac{p_{0} (1-p_{0})}{n}}}$$
    :::
...
Let $p$ be the probability/rate of correctly identifying soda type.
:::
...
3.  **Obtain null distribution and p-value**
    ...
    i.  ::: {style="color: maroon"}
        ...
        -   success-failure: $np_{0} = 80(0.5) = 40$ and $n(1-p_{0}) = 80(0.5) = 40$, both $\geq 10$
