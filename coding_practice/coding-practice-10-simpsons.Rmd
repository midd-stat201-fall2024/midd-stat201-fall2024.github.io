...
4.  Re-create your first visualization from Exercise 1, this time faceting by `age_cat`.

```{r}

```

5.  Elaborate on your table from Exercise 2 above by breaking it down by age category.
